...
<div class="jumbotron jumbotron-fluid bg-light">
    <div class="container text-center">
        ...
        <h2 class="display-4 my-3">Daftar Kuliner Kota & Kabupaten Tegal</h2>
        <p class="lead">Berikut Beberapa Daftar Kuliner yang ada di Tegal</p>
    </div>
</div>
...
<section class="p-t-20">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="title-6 m-b-35 text-dark">Daftar Kuliner Kota Tegal</h3>
