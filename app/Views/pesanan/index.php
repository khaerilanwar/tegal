                        ...
                        <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                            ...
                            <?php else : ?>
                                <button type="button" <?php if ($data['status'] == '0') {
                                                                    ...
                                                                    echo 'data-modal-target="modalTiket' . $data['id_pesan'] . '" data-modal-toggle="modalTiket' . $data['id_pesan'] . '"';
...
<?php foreach ($pesanan as $data) : ?>
    <?php if ($data['status'] == '2' and $data['jenis_pesan'] == 'wisata') : ?>
        <!-- Small Modal -->
        <div id="modalTiket<?= $data['id_pesan']; ?>" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="modalTiket<?= $data['id_pesan']; ?>">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <form action="/pesanan/pakai-tiket" method="post">
                                <input type="hidden" name="id_pesan" value="<?= $data['id_pesan']; ?>">
                                <button type="submit" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Pakai tiket</button>
                            </form>
                        </div>
