        ...
        <div class="flex">
            ...
            <div id="dropdown-kategori" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                    <li>
                        <button type="button" class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">All menus</button>
                    </li>
                    <li>
...
<div class="container mx-auto sm:px-20 px-5">
    <h2 class="font-heebo font-bold text-2xl md:px-3 md:text-4xl text-center my-12 dark:text-white">Aneka Kuliner Khas Daerah
    </h2>
    ...
    <div class="flex justify-center sm:gap-16 flex-wrap">
        ...
        <?php foreach ($kuliner as $data) : ?>
            <div class="rounded-lg shadow-md p-3 mb-4">
                <a href="/kuliner/detail/<?= $data['id']; ?>" class="mb-5 block rounded-full w-80 h-80 relative overflow-hidden border-x-4 border-red-500 group">
