...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <?= $this->include('layouts/adm_navbar'); ?>

        <!-- PAGE CONTENT-->
        <div class="page-content--bgf7">

            <?= $this->include('layouts/adm_welcome'); ?>

            <?= $this->include('layouts/adm_statistik'); ?>

            <?= $this->include('layouts/adm_tabel'); ?>

            <?= $this->include('layouts/adm_footer'); ?>
        </div>
