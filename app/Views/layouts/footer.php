<div class="container-fluid p-0">
    <footer class="d-flex bg-biru flex-wrap justify-content-between align-items-center py-3 border-top">
        <p class="text-white ps-5 justify-content-center col-sm-4 mb-0">&copy; 2022 Kelompok 3</p>

        <a href="/" class="col-sm-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
